...
export type FormForgotPassword = z.infer<typeof forgotPasswordZod>;
export type FormResetPassword = z.infer<typeof resetPasswordZod>;
...
}) satisfies z.ZodType<{ password: string }>;
...
}) satisfies z.ZodType<{ ids: string[] }>;
...
export type BulkDelete = z.infer<typeof bulkDeleteZod>;
// export type DefaultUser = z.infer<typeof userSchema>;
export type DeleteUser = z.infer<typeof deleteUserZod>;
export type DeactivateUserInput = z.infer<typeof deactivateUserZod>;
export type DeleteUserInput = z.infer<typeof deleteUserZod>;
