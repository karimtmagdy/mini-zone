...
function AlertDescription({
  ...
  return (
    <div
      ...
      className={cn(
        "text-muted-foreground [&_a]:hover:text-foreground opacity-80 text-sm text-balance md:text-pretty [&_a]:underline [&_a]:underline-offset-3 [&_p:not(:last-child)]:mb-4",
        className,
      )}
      {...props}
    />
