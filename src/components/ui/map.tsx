...
const MapLibre = forwardRef<MapRef, MapProps>(function MapLibre(
  {
    children,
    className,
    theme: themeProp,
    ...
    >
      {closeButton && (
        <button
          type="button"
          onClick={handleClose}
          className="ring-offset-background focus:ring-ring absolute end-1 top-1 z-10 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-none"
