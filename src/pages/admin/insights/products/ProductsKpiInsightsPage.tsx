...
export default function ProductsKpiInsightsPage() {
  return (
    <div className="flex flex-col gap-8">
      <ProductsInsightsHeader />
      <ProductsInsightsStats />

      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
        <StockLevelTrendChart />
...
function ProductsInsightsHeader() {
  return (
    <div>
      <h1 className="text-3xl font-bold tracking-tight">Products Analytics</h1>
      <p className="text-muted-foreground italic">
        Comprehensive overview of your inventory health and product performance.
      </p>
    </div>
  );
}

function ProductsInsightsStats() {
  return (
    <div className="grid gap-4 md:grid-cols-3">
      <Card className="shadow-xs">
        ...
        <CardContent>
          ...
          <p className="text-muted-foreground text-xs">+12 added this month</p>
        </CardContent>
      </Card>
      <Card className="border-orange-500/20 bg-orange-500/5 shadow-xs">
        ...
        <CardContent>
          ...
          <p className="text-muted-foreground text-xs">Action required soon</p>
        </CardContent>
      </Card>
      <Card className="border-emerald-500/20 bg-emerald-500/5 shadow-xs">
        ...
        <CardContent>
          ...
          <p className="text-muted-foreground text-xs">Optimal stock levels</p>
        </CardContent>
      </Card>
    </div>
  );
