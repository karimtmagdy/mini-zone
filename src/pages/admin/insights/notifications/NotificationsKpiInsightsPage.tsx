...
export default function NotificationsKpiInsightsPage() {
  return (
    <div className="flex flex-col gap-8">
      ...
      <NotificationsInsightsStats />
      <DeliveryPerformanceChart />
    </div>
  );
}

function NotificationsInsightsHeader() {
  return (
    <div>
...
function NotificationsInsightsStats() {
  return (
    <div className="grid gap-4 md:grid-cols-3">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-muted-foreground text-xs">+2.1% from industry avg</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-sm font-medium">Push Click-through</CardTitle>
